...
#ifndef GOOGLE_PROTOBUF_INCLUDED_route_5fguide_2fv1_2froute_5fguide_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_route_5fguide_2fv1_2froute_5fguide_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::route_guide::v1::Feature* Arena::CreateMaybeMessage<::route_guide::v1::Feature>(Arena*);
template <>
::route_guide::v1::FeatureDatabase* Arena::CreateMaybeMessage<::route_guide::v1::FeatureDatabase>(Arena*);
template <>
::route_guide::v1::GetFeatureRequest* Arena::CreateMaybeMessage<::route_guide::v1::GetFeatureRequest>(Arena*);
template <>
::route_guide::v1::GetFeatureResponse* Arena::CreateMaybeMessage<::route_guide::v1::GetFeatureResponse>(Arena*);
template <>
::route_guide::v1::ListFeaturesRequest* Arena::CreateMaybeMessage<::route_guide::v1::ListFeaturesRequest>(Arena*);
template <>
::route_guide::v1::ListFeaturesResponse* Arena::CreateMaybeMessage<::route_guide::v1::ListFeaturesResponse>(Arena*);
template <>
::route_guide::v1::Point* Arena::CreateMaybeMessage<::route_guide::v1::Point>(Arena*);
template <>
::route_guide::v1::RecordRouteRequest* Arena::CreateMaybeMessage<::route_guide::v1::RecordRouteRequest>(Arena*);
template <>
::route_guide::v1::RecordRouteResponse* Arena::CreateMaybeMessage<::route_guide::v1::RecordRouteResponse>(Arena*);
template <>
::route_guide::v1::RouteChatRequest* Arena::CreateMaybeMessage<::route_guide::v1::RouteChatRequest>(Arena*);
template <>
::route_guide::v1::RouteChatResponse* Arena::CreateMaybeMessage<::route_guide::v1::RouteChatResponse>(Arena*);
template <>
::route_guide::v1::RouteNote* Arena::CreateMaybeMessage<::route_guide::v1::RouteNote>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_route_5fguide_2fv1_2froute_5fguide_2eproto_2epb_2eh
