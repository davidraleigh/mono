 ...
 * </pre>
 *
 * Protobuf type {@code route_guide.v1.FeatureDatabase}
 */
public final class FeatureDatabase extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:route_guide.v1.FeatureDatabase)
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              feature_ = new java.util.ArrayList<io.grpc.route_guide.v1.Feature>();
              mutable_bitField0_ |= 0x00000001;
            }
            feature_.add(
                input.readMessage(io.grpc.route_guide.v1.Feature.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return io.grpc.route_guide.v1.RouteGuideProto.internal_static_route_guide_v1_FeatureDatabase_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grpc.route_guide.v1.FeatureDatabase.class, io.grpc.route_guide.v1.FeatureDatabase.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<io.grpc.route_guide.v1.Feature> getFeatureList() {
    return feature_;
  }
  /**
   * <code>repeated .route_guide.v1.Feature feature = 1 [json_name = "feature"];</code>
   ...
   */
  @java.lang.Override
  public io.grpc.route_guide.v1.Feature getFeature(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grpc.route_guide.v1.FeatureDatabase)) {
      return super.equals(obj);
    }
    io.grpc.route_guide.v1.FeatureDatabase other = (io.grpc.route_guide.v1.FeatureDatabase) obj;
  ...
  public static io.grpc.route_guide.v1.FeatureDatabase parseFrom(
  ...
  public static io.grpc.route_guide.v1.FeatureDatabase parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grpc.route_guide.v1.FeatureDatabase parseFrom(
  ...
  public static io.grpc.route_guide.v1.FeatureDatabase parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grpc.route_guide.v1.FeatureDatabase parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grpc.route_guide.v1.FeatureDatabase parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grpc.route_guide.v1.FeatureDatabase prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:route_guide.v1.FeatureDatabase)
      io.grpc.route_guide.v1.FeatureDatabaseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grpc.route_guide.v1.RouteGuideProto.internal_static_route_guide_v1_FeatureDatabase_descriptor;
    }
    ...
    // Construct using io.grpc.route_guide.v1.FeatureDatabase.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grpc.route_guide.v1.FeatureDatabase getDefaultInstanceForType() {
      return io.grpc.route_guide.v1.FeatureDatabase.getDefaultInstance();
    }

    @java.lang.Override
    public io.grpc.route_guide.v1.FeatureDatabase build() {
      io.grpc.route_guide.v1.FeatureDatabase result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grpc.route_guide.v1.FeatureDatabase) {
        return mergeFrom((io.grpc.route_guide.v1.FeatureDatabase)other);
      } else {
    ...
    public Builder mergeFrom(io.grpc.route_guide.v1.FeatureDatabase other) {
      if (other == io.grpc.route_guide.v1.FeatureDatabase.getDefaultInstance()) return this;
      if (featureBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grpc.route_guide.v1.FeatureDatabase parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grpc.route_guide.v1.FeatureDatabase) e.getUnfinishedMessage();
    ...
    private void ensureFeatureIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        feature_ = new java.util.ArrayList<io.grpc.route_guide.v1.Feature>(feature_);
    ...
    public Builder setFeature(
        int index, io.grpc.route_guide.v1.Feature value) {
      if (featureBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setFeature(
        int index, io.grpc.route_guide.v1.Feature.Builder builderForValue) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .route_guide.v1.Feature feature = 1 [json_name = "feature"];</code>
     */
    public Builder addFeature(io.grpc.route_guide.v1.Feature value) {
      if (featureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllFeature(
        java.lang.Iterable<? extends io.grpc.route_guide.v1.Feature> values) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .route_guide.v1.Feature feature = 1 [json_name = "feature"];</code>
     */
    public io.grpc.route_guide.v1.Feature.Builder addFeatureBuilder() {
      return getFeatureFieldBuilder().addBuilder(
          io.grpc.route_guide.v1.Feature.getDefaultInstance());
    }
    /**
     * <code>repeated .route_guide.v1.Feature feature = 1 [json_name = "feature"];</code>
     */
    public io.grpc.route_guide.v1.Feature.Builder addFeatureBuilder(
        int index) {
      return getFeatureFieldBuilder().addBuilder(
          index, io.grpc.route_guide.v1.Feature.getDefaultInstance());
    }
    /**
     * <code>repeated .route_guide.v1.Feature feature = 1 [json_name = "feature"];</code>
     */
    ...
    // @@protoc_insertion_point(builder_scope:route_guide.v1.FeatureDatabase)
  }

  // @@protoc_insertion_point(class_scope:route_guide.v1.FeatureDatabase)
  private static final io.grpc.route_guide.v1.FeatureDatabase DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grpc.route_guide.v1.FeatureDatabase();
  }

  public static io.grpc.route_guide.v1.FeatureDatabase getDefaultInstance() {
